...
export interface DialogFormProps<T extends Record<string, unknown>> extends Omit<DialogProps, 'onOk'> {
...
const DialogForm = <T extends Record<string, unknown>>(props: DialogFormProps<T>) => {
