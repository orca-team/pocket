...
import type { JsonValueType } from '@orca-fe/antd-plus';
import { JsonSchemaEditor } from '@orca-fe/antd-plus';
...
const Demo = (props) => {
  ...
  const str = useMemo(() => JsonSchemaEditor.toTypeScriptDefinition(value), [value]);
